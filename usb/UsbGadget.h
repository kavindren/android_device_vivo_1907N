...
// mt6768 (this SoC family) exposes its USB controller through the MUSB driver, not the DWC3
// controller upstream's default hardcodes (kGadgetName was "a600000.dwc3" - a Qualcomm device
// tree node address, meaningless here). This is the one required device-specific substitution;
// everything else in this file/usb/lib now tracks hardware/interfaces/usb/gadget/1.1/default
// as closely as possible instead of an older, independently-drifted copy.
