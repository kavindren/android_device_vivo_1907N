...
# power-default (vendor/vivo/1907N/proprietary/vendor/etc/vintf/manifest/power-default.xml, a
# stock-extracted vintf fragment) redundantly re-declares android.hardware.power/IPower/default@2,
# the exact same instance this device's own manifest.xml already declares for the real running
# vendor.mediatek.hardware.mtkpower@1.0-service. Harmless duplication under LOS20's looser
# checkvintf, but LOS21's is strict about it: "Conflicting FqInstance: IPower/default (@2)".
# Excluded here instead of hand-editing 1907N-vendor.mk, which is auto-generated by
# setup-makefiles.sh and would silently lose this exclusion on the next re-extraction.
PRODUCT_PACKAGES := $(filter-out power-default,$(PRODUCT_PACKAGES))
